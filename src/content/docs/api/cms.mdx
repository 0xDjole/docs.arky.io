...
Before using the raw API, see the **[CMS Content Integration Guide](/guides/integrations/cms/)** for complete patterns:
...
**See [CMS Integration Guide](/guides/integrations/cms/) for full patterns.**
