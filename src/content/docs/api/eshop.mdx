...
Before diving into the raw API, check out the **[E-commerce Integration Guide](/guides/integrations/ecommerce/)** for complete flows:
...
**See [E-commerce Integration Guide](/guides/integrations/ecommerce/) for complete patterns.**
