...
Before using the raw API, see the **[Reservation Booking Integration Guide](/guides/integrations/reservations/)** for complete flows:
...
**See [Reservation Integration Guide](/guides/integrations/reservations/) for full patterns.**
